...
class RunScoutGameTest {
 ...
 fn(p,"1/cast");ok(score(p,"scout.charges")==1 && score(p,"range.lc.cd")==0,"first shot spends charge without starting CD");ok(score(p,"charging_bow")==7,"manual shot preserves bow draw score");
 ...
 fn(p,"1/cast");fn(p,"1/cast");ok(score(p,"scout.charges")==0,"second charge starts CD and third shot rejected");
