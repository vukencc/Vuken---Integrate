...
execute if score @s class matches 4 if items entity @s weapon.mainhand #range at @s run function core:class/ability/scout/7/cast

execute if score @s class matches 5 if items entity @s weapon.mainhand *[enchantments~[{enchantments:"core:inter/sword_effect"}]] if score @s melee.sswap matches 1.. at @s run function core:class/ability/assassin/2/cast