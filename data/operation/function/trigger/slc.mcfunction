...
execute if score @s class matches 5 if items entity @s weapon.mainhand *[enchantments~[{enchantments:"core:inter/sword_effect"}]] if score @s melee.slc matches 1.. run function core:class/ability/assassin/4/cast
