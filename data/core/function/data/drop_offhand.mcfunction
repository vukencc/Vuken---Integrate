...
execute if score @s class matches 5 if items entity @s weapon.mainhand *[enchantments~[{enchantments:"core:inter/sword_effect"}]] if predicate operation:stats/sneaking run return run function operation:trigger/sswap
