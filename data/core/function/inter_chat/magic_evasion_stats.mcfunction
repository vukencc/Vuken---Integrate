...
tellraw @s [{translate:name.magic_evasion.lore,"fallback":"Magic Evasion Chance : ",color:white,bold:true},{score:{name:"@s",objective:"stdTemp1"},color:"#ade6ff",bold:true},{"text":"%",color:"#ade6ff",bold:true}]
