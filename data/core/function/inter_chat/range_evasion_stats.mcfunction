...
tellraw @s [{translate:name.range_evasion.lore,"fallback":"Range Evasion Chance : ",color:white,bold:true},{score:{name:"@s",objective:"stdTemp1"},color:"#ade6ff",bold:true},{"text":"%",color:"#ade6ff",bold:true}]
