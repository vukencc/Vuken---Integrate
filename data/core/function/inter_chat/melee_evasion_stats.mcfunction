...
tellraw @s [{translate:name.melee_evasion.lore,"fallback":"Melee Evasion Chance : ",color:white,bold:true},{score:{name:"@s",objective:"stdTemp1"},color:"#ade6ff",bold:true},{"text":"%",color:"#ade6ff",bold:true}]
