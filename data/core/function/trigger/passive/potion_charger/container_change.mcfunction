...
$data modify entity @n[type=armor_stand,tag=stdTemp1] equipment.head.components."minecraft:custom_data".PotionCharger set from entity @n[type=acacia_chest_boat,distance=..8,tag=PotionCharger.Init,scores={marker=$(id)}] Items
