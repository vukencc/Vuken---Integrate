...
execute store result score @s bacTemp1 run data get entity @s equipment.head.components."minecraft:enchantments"."core:defence/magic_protection" 6
execute store result score @s bacTemp2 run data get entity @s equipment.chest.components."minecraft:enchantments"."core:defence/magic_protection" 6
execute store result score @s bacTemp3 run data get entity @s equipment.legs.components."minecraft:enchantments"."core:defence/magic_protection" 6
execute store result score @s bacTemp4 run data get entity @s equipment.feet.components."minecraft:enchantments"."core:defence/magic_protection" 6
execute store result score @s bacTemp5 run data get entity @s equipment.offhand.components."minecraft:enchantments"."core:defence/magic_protection" 6
execute store result score @s bacTemp6 run data get entity @s SelectedItem.components."minecraft:enchantments"."core:defence/magic_protection" 6
...
execute store result score @s bacTemp1 run data get entity @s equipment.head.components."minecraft:enchantments"."core:defence/magic_evasion" 2
execute store result score @s bacTemp2 run data get entity @s equipment.chest.components."minecraft:enchantments"."core:defence/magic_evasion" 2
execute store result score @s bacTemp3 run data get entity @s equipment.legs.components."minecraft:enchantments"."core:defence/magic_evasion" 2
execute store result score @s bacTemp4 run data get entity @s equipment.feet.components."minecraft:enchantments"."core:defence/magic_evasion" 2
execute store result score @s bacTemp5 run data get entity @s equipment.offhand.components."minecraft:enchantments"."core:defence/magic_evasion" 2
execute store result score @s bacTemp6 run data get entity @s SelectedItem.components."minecraft:enchantments"."core:defence/magic_evasion" 2
