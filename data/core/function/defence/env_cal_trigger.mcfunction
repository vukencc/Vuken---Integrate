...
execute if score $difficulty config matches 1 store result storage temp temp double 0.85 run scoreboard players get @s damageResisted
execute if score $difficulty config matches 2 store result storage temp temp double 1 run scoreboard players get @s damageResisted
execute if score $difficulty config matches 3 store result storage temp temp double 1.15 run scoreboard players get @s damageResisted
execute store result score @s damageResisted run data get storage temp temp
...
execute store result score @s bacTemp1 run data get entity @s equipment.head.components."minecraft:enchantments"."core:defence/env_protection" 6
execute store result score @s bacTemp2 run data get entity @s equipment.chest.components."minecraft:enchantments"."core:defence/env_protection" 6
execute store result score @s bacTemp3 run data get entity @s equipment.legs.components."minecraft:enchantments"."core:defence/env_protection" 6
execute store result score @s bacTemp4 run data get entity @s equipment.feet.components."minecraft:enchantments"."core:defence/env_protection" 6
execute store result score @s bacTemp5 run data get entity @s equipment.offhand.components."minecraft:enchantments"."core:defence/env_protection" 6
execute store result score @s bacTemp6 run data get entity @s SelectedItem.components."minecraft:enchantments"."core:defence/env_protection" 6
