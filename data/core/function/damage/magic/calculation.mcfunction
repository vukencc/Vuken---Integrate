attribute @s movement_efficiency modifier remove vanilla_mme_modifier
execute store result score @s stdTemp1 run attribute @s movement_efficiency get 10000
