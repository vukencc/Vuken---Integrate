...
execute as @s store result score @s stdTemp1 run attribute @s max_health get 0.6
execute as @s at @s if score @s health <= @s stdTemp1 run function core:custom_ench/defence/revolve
execute as @s at @s if score @s health > @s stdTemp1 run function core:custom_ench/defence/courage
execute as @s at @s if score @s time_not_taking_damage matches ..40 run function core:custom_ench/defence/ethereal
execute as @s at @s if score @s time_not_taking_damage matches 80.. run function core:custom_ench/defence/tempo
