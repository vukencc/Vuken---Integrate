...
execute if score @s range.lc matches 1..2 unless score @s range.lc.cd matches 1.. unless score @s scout.charges matches 1.. run function core:class/ability/scout/1/refill
