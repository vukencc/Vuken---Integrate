# @s is the victim; DamageOwner is the caller's attacker. Compute once before damage.
...
execute if score @s assassin.8.facing matches 9001.. run function core:class/ability/assassin/8/custom_bonus
execute if score @s assassin.8.facing matches ..-9001 run function core:class/ability/assassin/8/custom_bonus
