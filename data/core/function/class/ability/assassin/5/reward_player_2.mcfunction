...
function core:class/ability/util/reduce_cd_pattern {scb:melee.drop,value:60}
...
function vfam:add {target:"@s",effect:attack_damage,id:assassin_5_dmg,value:0.6,duration:120,type:add_multiplied_total}
function vfam:add {target:"@s",effect:attack_speed,id:assassin_5_spd,value:0.4,duration:120,type:add_multiplied_total}
particle enchant ~ ~1 ~ 0.45 0.7 0.45 0.15 24 normal
